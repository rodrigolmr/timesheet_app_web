...
part 'job_draft_model.freezed.dart';
part 'job_draft_model.g.dart';

@freezed
class JobDraftModel with _$JobDraftModel {
  const JobDraftModel._();
  
  const factory JobDraftModel({
    // Campos do sistema
    required String id,
  ...
  factory JobDraftModel.fromJson(Map<String, dynamic> json) => 
      _$JobDraftModelFromJson(json);

  factory JobDraftModel.fromFirestore(DocumentSnapshot<Map<String, dynamic>> doc) {
    final data = doc.data()!;
    return JobDraftModel(
      id: doc.id,
