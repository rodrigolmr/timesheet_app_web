...
String _$addressSuggestionsHash() =>
    r'3184d50ff6424fafe36793391e521f2e2b486dd9';

/// See also [addressSuggestions].
@ProviderFor(addressSuggestions)
const addressSuggestionsProvider = AddressSuggestionsFamily();

/// See also [addressSuggestions].
class AddressSuggestionsFamily extends Family<AsyncValue<List<String>>> {
  /// See also [addressSuggestions].
  const AddressSuggestionsFamily();

  /// See also [addressSuggestions].
  AddressSuggestionsProvider call(String query) {
    return AddressSuggestionsProvider(query);
  }

  @override
  AddressSuggestionsProvider getProviderOverride(
    covariant AddressSuggestionsProvider provider,
  ) {
  ...
  @override
  String? get name => r'addressSuggestionsProvider';
}

/// See also [addressSuggestions].
class AddressSuggestionsProvider
    extends AutoDisposeFutureProvider<List<String>> {
  /// See also [addressSuggestions].
  AddressSuggestionsProvider(String query)
    : this._internal(
        (ref) => addressSuggestions(ref as AddressSuggestionsRef, query),
        from: addressSuggestionsProvider,
        name: r'addressSuggestionsProvider',
        debugGetCreateSourceHash:
            const bool.fromEnvironment('dart.vm.product')
                ? null
                : _$addressSuggestionsHash,
        dependencies: AddressSuggestionsFamily._dependencies,
        allTransitiveDependencies:
            AddressSuggestionsFamily._allTransitiveDependencies,
        query: query,
      );

  AddressSuggestionsProvider._internal(
    super._createNotifier, {
    required super.name,
    required super.dependencies,
    required super.allTransitiveDependencies,
  ...
  @override
  Override overrideWith(
    FutureOr<List<String>> Function(AddressSuggestionsRef provider) create,
  ) {
    return ProviderOverride(
      origin: this,
      override: AddressSuggestionsProvider._internal(
        (ref) => create(ref as AddressSuggestionsRef),
        from: from,
        name: null,
        dependencies: null,
        allTransitiveDependencies: null,
  ...
  AutoDisposeFutureProviderElement<List<String>> createElement() {
    return _AddressSuggestionsProviderElement(this);
  }

  @override
  bool operator ==(Object other) {
    return other is AddressSuggestionsProvider && other.query == query;
  }
...
@Deprecated('Will be removed in 3.0. Use Ref instead')
// ignore: unused_element
mixin AddressSuggestionsRef on AutoDisposeFutureProviderRef<List<String>> {
  /// The parameter `query` of this provider.
  String get query;
}

class _AddressSuggestionsProviderElement
    extends AutoDisposeFutureProviderElement<List<String>>
    with AddressSuggestionsRef {
  _AddressSuggestionsProviderElement(super.provider);

  @override
  String get query => (origin as AddressSuggestionsProvider).query;
}
