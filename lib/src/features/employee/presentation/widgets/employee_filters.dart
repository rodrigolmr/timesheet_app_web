...
class EmployeeFilters extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<EmployeeFilters> createState() => _EmployeeFiltersState();
}

class _EmployeeFiltersState extends ConsumerState<EmployeeFilters> {
  @override
