...
class CompanyCardFilters extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<CompanyCardFilters> createState() => _CompanyCardFiltersState();
}

class _CompanyCardFiltersState extends ConsumerState<CompanyCardFilters> {
  @override
